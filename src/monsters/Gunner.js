...
module.exports = (function() {
  ...
  GunnerWalkRight.src = './img/monsters/Gunner_Walk_Right.png';

  // The left walking Gunner spritesheet
  var GunnerWalkLeft = new Image();
  GunnerWalkLeft.src = "./img/monsters/Gunner_Walk_Left.png";

  // The right attacking Gunner spritesheet
  var GunnerAttackRight = new Image();
  GunnerAttackRight.src = "./img/monsters/Gunner_Attack_Right.png";

  // The left attacking Gunner spritesheet
  var GunnerAttackLeft = new Image();
  GunnerAttackLeft.src = "./img/monsters/Gunner_Attack_Left.png";
