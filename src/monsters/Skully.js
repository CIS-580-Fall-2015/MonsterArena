...
module.exports = (function() {
  ...
  SkullyWalkRight.src = './img/monsters/Skully_Walk_Right.png';

  // The left walking Skully spritesheet
  var SkullyWalkLeft = new Image();
  SkullyWalkLeft.src = "./img/monsters/Skully_Walk_Left.png";

  // The right attacking Skully spritesheet
  var SkullyAttackRight = new Image();
  SkullyAttackRight.src = "./img/monsters/Skully_Attack_Right.png";

  // The left attacking Skully spritesheet
  var SkullyAttackLeft = new Image();
  SkullyAttackLeft.src = "./img/monsters/Skully_Attack_Left.png";
